...
urlpatterns = [
    ...
    url(r'^clinic/(?P<pk>[\d]+)/$', views.ClinicView.as_view(), name='clinic_detail'),
    url(r'^doctor_setting/clinic/(?P<clinic_id>[\d]+)/$', views.DoctorSettingView.as_view(), name='doctor_setting'),
