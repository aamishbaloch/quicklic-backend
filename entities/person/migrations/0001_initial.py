# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-19 13:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('U', 'Unknown'), ('F', 'Female'), ('M', 'Male')], default='U', max_length=1, verbose_name='gender')),
                ('role', models.CharField(choices=[('DR', 'DOCTOR'), ('PA', 'PATIENT'), ('AD', 'ADMIN'), ('QA', 'QA')], max_length=2, verbose_name='role')),
